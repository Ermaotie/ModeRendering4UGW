...
for t = time
    ...
    % pause(0.05);
    % colorbar;
    exportgraphics(gcf,'image_0.003/m'+string(m)+'-Cg'+string(cg)+'-f'+string(f)+'kHz'+'-3d.gif','Append',true);
end
...
saveas(figure(3),'image_0.003_Cg/m'+string(m)+'-Cg'+string(cg)+'-f'+string(f)+'kHz'+'-3d.png');
saveas(figure(3),'image_0.003_Cg/m'+string(m)+'-Cg'+string(cg)+'-f'+string(f)+'kHz'+'-3d.fig');
